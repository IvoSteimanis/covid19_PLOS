...
do "$working_ANALYSIS/scripts/1_1_clean_wave1.do"
do "$working_ANALYSIS/scripts/1_2_clean_wave2.do"
do "$working_ANALYSIS/scripts/1_3_merge_generate.do"
do "$working_ANALYSIS/scripts/02_analysis.do"
do "$working_ANALYSIS/scripts/03_robustness_checks_no_exclusion.do"
do "$working_ANALYSIS/scripts/04_figure2_germany_map.do"
do "$working_ANALYSIS/scripts/05_figureS1_dogmatism_scale.do"
do "$working_ANALYSIS/scripts/06_AppendixS7.do"
do "$working_ANALYSIS/scripts/07_AppendixS10.do"
